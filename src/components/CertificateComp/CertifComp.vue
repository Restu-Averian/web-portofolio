<template>
  <div class="flex flex-col items-center p-10">
    <h1 class="text-4xl font-Avocados text-primary">Certificates</h1>
    <div class="p-24">
          ...
          <div class="mb-5 flex justify-between items-center">
            <div>
              ...
              <p class="text-slate-300 mt-2">
                {{ infoProject.mitra }} - {{ infoProject.GetTime }}
              </p>
            </div>
            <button
...
export default {
  ...
  methods: {
    ...
    expandItems(index) {
      ...
      this.infoProject.mitra = hasil[0].mitra;
      this.infoProject.GetTime = hasil[0].GetTime;
